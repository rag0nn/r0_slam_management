...
class DataProvider(rclpy.node.Node):
    ...
    def __init__(self):
        ...
        self.depth_topic ,self.depth_pub_periot ,self.depth_pub_queue_size ,_ ,self.depth_frame_id ,self.depth_data_path, self.depth_typeruntime,self.depth_typeshowtime  = depth_params
    ...
    def _get_image_names(self):
        ...
        depth_names = sorted(glob(f"{self.depth_data_path}/*"))
